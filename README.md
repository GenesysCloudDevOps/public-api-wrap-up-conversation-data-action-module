A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Wrap Up Conversation
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-wrap-up-conversation-data-action-module.git?ref=main"
    action_name        = "Wrap Up Conversation"
